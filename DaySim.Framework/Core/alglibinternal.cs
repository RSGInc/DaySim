  ...
  public class apserv {
    ...
    *************************************************************************/
    public static void apperiodicmap(ref double x,
      ...
      alglib.ap.assert(a < b, "APPeriodicMap: internal error!");
    ...
    *************************************************************************/
    public static void rankx(ref double[] x,
        ...
        do {
          ...
          while (t != 0) {
            ...
            if (k > i) {
              ...
              if (k < i) {
                if (buf.ra1[k] > buf.ra1[k - 1]) {
                  k = k + 1;
                }
              }
              if (buf.ra1[t - 1] >= buf.ra1[k - 1]) {
                t = 0;
              } else {
                tmp = buf.ra1[k - 1];
                buf.ra1[k - 1] = buf.ra1[t - 1];
      ...
      while (i <= n - 1) {
        j = i + 1;
        while (j <= n - 1) {
          if (buf.ra1[j] != buf.ra1[i]) {
            break;
          }
          j = j + 1;
        }
        for (k = i; k <= j - 1; k++) {
          buf.ra1[k] = 1 + (i + j - 1) / (double)2;
        }
        i = j;
      }
  ...
  public class reflections {
    ...
    *************************************************************************/
    public static void generatereflection(ref double[] x,
      ...
      s = 1;
      if (mx != 0) {
        if (mx <= math.minrealnumber / math.machineepsilon) {
          ...
          if (mx >= math.maxrealnumber * math.machineepsilon) {
  ...
  public class linmin {
    ...
    *************************************************************************/
    public static bool armijoiteration(armijostate state) {
      ...
      // Bound StpLen
      //
      if (state.stplen > state.stpmax && state.stpmax != 0) {
      ...
      if (v > state.stpmax && state.stpmax != 0) {
        v = state.stpmax;
      }
      for (i_ = 0; i_ <= n - 1; i_++) {
