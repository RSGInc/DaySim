  ...
  public class bessel {
    ...
    *************************************************************************/
    public static double besselk0(double x) {
      ...
      alglib.ap.assert(x > 0, "Domain error in BesselK0: x<=0");
      if (x <= 2) {
        y = x * x - 2.0;
    ...
    *************************************************************************/
    public static double besselk1(double x) {
      ...
      z = 0.5 * x;
      alglib.ap.assert(z > 0, "Domain error in K1");
      if (x <= 2) {
        y = x * x - 2.0;
    ...
    *************************************************************************/
    public static double besselkn(int nn,
      ...
      alglib.ap.assert(x > 0, "Domain error in BesselKN");
      if (x <= 9.55) {
        ans = 0.0;
        z0 = 0.25 * x * x;
        fn = 1.0;
        ...
        if (n > 0) {
          ...
          if (n == 1) {
            ...
            for (i = 1; i <= n - 1; i++) {
              ...
              t = nk1f * zn / kf;
              s = s + t;
              alglib.ap.assert(math.maxrealnumber - Math.Abs(t) > Math.Abs(s), "Overflow in BesselKN");
              alglib.ap.assert(!(tox > 1.0 && math.maxrealnumber / tox < zmn), "Overflow in BesselKN");
              zmn = zmn * tox;
            }
            s = s * 0.5;
            t = Math.Abs(s);
            alglib.ap.assert(!(zmn > 1.0 && math.maxrealnumber / zmn < t), "Overflow in BesselKN");
            alglib.ap.assert(!(t > 1.0 && math.maxrealnumber / t < zmn), "Overflow in BesselKN");
            ans = s * zmn;
          }
        }
  ...
  public class betaf {
    ...
    *************************************************************************/
    public static double beta(double a,
      ...
      sg = 1;
      alglib.ap.assert(a > 0 || a != (int)Math.Floor(a), "Overflow in Beta");
      alglib.ap.assert(b > 0 || b != (int)Math.Floor(b), "Overflow in Beta");
      y = a + b;
      if (Math.Abs(y) > 171.624376956302725) {
        ...
        sg = sg * s;
        alglib.ap.assert(y <= Math.Log(math.maxrealnumber), "Overflow in Beta");
        result = sg * Math.Exp(y);
        return result;
      }
      y = gammafunc.gammafunction(y);
      alglib.ap.assert(y != 0, "Overflow in Beta");
      if (a > b) {
  ...
  public class ibetaf {
    ...
    *************************************************************************/
    public static double incompletebeta(double a,
      ...
      alglib.ap.assert(a > 0 && b > 0, "Domain error in IncompleteBeta");
      alglib.ap.assert(x >= 0 && x <= 1, "Domain error in IncompleteBeta");
      if (x == 0) {
        result = 0;
        return result;
      }
    ...
    *************************************************************************/
    public static double invincompletebeta(double a,
      ...
      i = 0;
      alglib.ap.assert(y >= 0 && y <= 1, "Domain error in InvIncompleteBeta");
      ...
      while (true) {
        ...
        if (mainlooppos == newtcycle) {
          if (i <= 7) {
            ...
            x = xt;
            if (Math.Abs(d / x) < 128.0 * math.machineepsilon) {
              break;
            }
            i = i + 1;
            mainlooppos = newtcycle;
  ...
  public class binomialdistr {
    ...
    *************************************************************************/
    public static double binomialdistribution(int k,
      ...
      alglib.ap.assert(p >= 0 && p <= 1, "Domain error in BinomialDistribution");
    ...
    *************************************************************************/
    public static double binomialcdistribution(int k,
      ...
      alglib.ap.assert(p >= 0 && p <= 1, "Domain error in BinomialDistributionC");
  ...
  public class chisquaredistr {
    ...
    *************************************************************************/
    public static double chisquaredistribution(double v,
      ...
      alglib.ap.assert(x >= 0 && v >= 1, "Domain error in ChiSquareDistribution");
    ...
    *************************************************************************/
    public static double chisquarecdistribution(double v,
      ...
      alglib.ap.assert(x >= 0 && v >= 1, "Domain error in ChiSquareDistributionC");
    ...
    *************************************************************************/
    public static double invchisquaredistribution(double v,
      ...
      alglib.ap.assert((y >= 0 && y <= 1) && v >= 1, "Domain error in InvChiSquareDistribution");
  ...
  public class elliptic {
    ...
    *************************************************************************/
    public static double ellipticintegrale(double m) {
      ...
      alglib.ap.assert(m >= 0 && m <= 1, "Domain error in EllipticIntegralE: m<0 or m>1");
      m = 1 - m;
      if (m == 0) {
        result = 1;
        return result;
  ...
  public class fdistr {
    ...
    *************************************************************************/
    public static double fdistribution(int a,
      ...
      alglib.ap.assert((a >= 1 && b >= 1) && x >= 0, "Domain error in FDistribution");
      w = a * x;
      w = w / (b + w);
    ...
    *************************************************************************/
    public static double fcdistribution(int a,
      ...
      alglib.ap.assert((a >= 1 && b >= 1) && x >= 0, "Domain error in FCDistribution");
      w = b / (b + a * x);
    ...
    *************************************************************************/
    public static double invfdistribution(int a,
      ...
      alglib.ap.assert(((a >= 1 && b >= 1) && y > 0) && y <= 1, "Domain error in InvFDistribution");
  ...
  public class jacobianelliptic {
    ...
    *************************************************************************/
    public static void jacobianellipticfunctions(double u,
      ...
      alglib.ap.assert(m >= 0 && m <= 1, "Domain error in JacobianEllipticFunctions: m<0 or m>1");
      a = new double[8 + 1];
      c = new double[8 + 1];
      if (m < 1.0e-9) {
        t = Math.Sin(u);
  ...
  public class poissondistr {
    ...
    *************************************************************************/
    public static double poissondistribution(int k,
      ...
      alglib.ap.assert(k >= 0 && m > 0, "Domain error in PoissonDistribution");
    ...
    *************************************************************************/
    public static double poissoncdistribution(int k,
      ...
      alglib.ap.assert(k >= 0 && m > 0, "Domain error in PoissonDistributionC");
    ...
    *************************************************************************/
    public static double invpoissondistribution(int k,
      ...
      alglib.ap.assert((k >= 0 && y >= 0) && y < 1, "Domain error in InvPoissonDistribution");
  ...
  public class studenttdistr {
    ...
    *************************************************************************/
    public static double invstudenttdistribution(int k,
      ...
      alglib.ap.assert((k > 0 && p > 0) && p < 1, "Domain error in InvStudentTDistribution");
      rk = k;
      if (p > 0.25 && p < 0.75) {
        if (p == 0.5) {
          result = 0;
