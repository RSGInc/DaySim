...
namespace Daysim.ChoiceModels.Actum.Models {
	public class OtherHomeBasedTourTimeModel : ChoiceModel {
		private const string CHOICE_MODEL_NAME = "ActumOtherHomeBasedTourTimeModel";
		...
		private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, TourWrapper tour, TourTime choice = null) {
