  ...
  public class TourModeTimeModel : ChoiceModel {
    ...
    public void Run(HouseholdDayWrapper householdDay, TourWrapper tour,
      ...
      if (_helpers[ParallelUtility.threadLocalAssignedIndex.Value].ModelIsInEstimationMode) {
        ...
        tour.HalfTour1AccessStopAreaParcelID = choice.ParkAndRideOriginStopAreaParcelID;
        tour.HalfTour1AccessStopAreaZoneID = choice.ParkAndRideOriginStopAreaZoneID;
        tour.HalfTour1AccessParkingNodeID = choice.ParkAndRideOriginParkingNodeID;
        ...
        tour.HalfTour1EgressStopAreaParcelID = choice.ParkAndRideDestinationStopAreaParcelID;
        tour.HalfTour1EgressStopAreaZoneID = choice.ParkAndRideDestinationStopAreaZoneID;
        tour.HalfTour1EgressParkingNodeID = choice.ParkAndRideDestinationParkingNodeID;
        ...
        tour.HalfTour2AccessStopAreaParcelID = choice.ParkAndRideDestinationStopAreaParcelID;
        tour.HalfTour2AccessStopAreaZoneID = choice.ParkAndRideDestinationStopAreaZoneID;
        tour.HalfTour2AccessParkingNodeID = choice.ParkAndRideDestinationParkingNodeID;
        ...
        tour.HalfTour2EgressStopAreaParcelID = choice.ParkAndRideOriginStopAreaParcelID;
        tour.HalfTour2EgressStopAreaZoneID = choice.ParkAndRideOriginStopAreaZoneID;
        tour.HalfTour2EgressParkingNodeID = choice.ParkAndRideOriginParkingNodeID;
