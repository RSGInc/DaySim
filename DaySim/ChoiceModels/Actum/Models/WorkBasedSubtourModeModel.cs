...
namespace Daysim.ChoiceModels.Actum.Models {
	public class WorkBasedSubtourModeModel : ChoiceModel {
		private const string CHOICE_MODEL_NAME = "ActumWorkBasedSubtourModeModel";
		...
		public ChoiceProbabilityCalculator.Alternative RunNested(TourWrapper subtour, IParcelWrapper destinationParcel) {
			if (subtour == null) {
				throw new ArgumentNullException("subtour");
			}
		...
		private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, ITourWrapper subtour, IEnumerable<PathTypeModel> pathTypeModels, IParcelWrapper destinationParcel, int parentTourMode, int choice = Constants.DEFAULT_VALUE) {
