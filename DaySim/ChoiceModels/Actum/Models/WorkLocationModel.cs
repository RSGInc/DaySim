...
namespace DaySim.ChoiceModels.Actum.Models {
  public class WorkLocationModel : ChoiceModel {
    ...
    private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, PersonWrapper person, int sampleSize, IParcelWrapper choice = null, bool choseHome = false) {
      ...
      System.Collections.Generic.Dictionary<DestinationSampler.TourSampleItem, int> sampleItems = destinationSampler.SampleAndReturnTourDestinations(workLocationUtilites);
      ...
      foreach (System.Collections.Generic.KeyValuePair<DestinationSampler.TourSampleItem, int> sampleItem in sampleItems) {
        ...
        ChoiceProbabilityCalculator.Alternative nestedAlternative = Global.ChoiceModelSession.Get<WorkTourModeTimeModel>().RunNested(person, person.Household.ResidenceParcel, destinationParcel, destinationArrivalTime, destinationDepartureTime, person.Household.HouseholdTotals.DrivingAgeMembers, 0.0);
