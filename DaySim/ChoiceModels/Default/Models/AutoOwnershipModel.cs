...
namespace DaySim.ChoiceModels.Default.Models {
  public class AutoOwnershipModel : ChoiceModel {
    ...
    private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, IHouseholdWrapper household, int choice = Constants.DEFAULT_VALUE) {
      ...
      double zeroVehSEEffect = (Global.Configuration.PaidRideShareModeIsAvailable && Global.Configuration.AV_PaidRideShareModeUsesAVs) ? Global.Configuration.AV_SharingEconomy_DensityCoeffcientForOwning0Vehicles * Math.Min(household.ResidenceBuffer2Density, 6000) : 0;
