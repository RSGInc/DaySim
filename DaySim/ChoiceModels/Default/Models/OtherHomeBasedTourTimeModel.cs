...
namespace DaySim.ChoiceModels.Default.Models {
  public class OtherHomeBasedTourTimeModel : ChoiceModel {
    public const string CHOICE_MODEL_NAME = "OtherHomeBasedTourTimeModel";
    ...
    private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, ITourWrapper tour, TourTime choice = null) {
      ...
      for (int periodIndex = 0; periodIndex < smallPeriodCount; periodIndex++) {
        ...
        if (departurePeriodAvailableMinutes > 0 || Global.Configuration.IsInEstimationMode) {
          ...
          //added
          //departureComponent.AddUtilityTerm(131, escortTourFlag * departurePeriodShift);
          //departureComponent.AddUtilityTerm(132, shoppingTourFlag * departurePeriodShift);
          //departureComponent.AddUtilityTerm(133, mealTourFlag * departurePeriodShift);
          //departureComponent.AddUtilityTerm(134, socialTourFlag * departurePeriodShift);
