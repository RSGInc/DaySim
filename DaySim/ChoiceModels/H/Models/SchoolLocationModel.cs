    ...
    public class SchoolLocationModel : ChoiceModel {
        ...
        private sealed class SchoolLocationUtilities : ISamplingUtilities {
            ...
            public void SetUtilities(ISampleItem sampleItem, int sampleFrequency) {
                ...
                var schoolTourLogsum = 0D;
                var nestedAlternative = Global.ChoiceModelSession.Get<SchoolTourModeTimeModel>().RunNested(_person, _person.Household.ResidenceParcel, destinationParcel, _destinationArrivalTime, _destinationDepartureTime, _person.Household.HouseholdTotals.DrivingAgeMembers, 0.0);
