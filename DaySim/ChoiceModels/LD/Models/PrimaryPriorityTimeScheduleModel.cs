...
namespace Daysim.ChoiceModels.LD.Models {
	public class PrimaryPriorityTimeScheduleModel : ChoiceModel {
		private const string CHOICE_MODEL_NAME = "LDPrimaryPriorityTimeScheduleModel";
		...
		{
			Initialize(CHOICE_MODEL_NAME, Global.Configuration.LDPrimaryPriorityTimeScheduleModelCoefficients, TOTAL_ALTERNATIVES, TOTAL_NESTED_ALTERNATIVES, TOTAL_LEVELS, MAX_PARAMETER);
