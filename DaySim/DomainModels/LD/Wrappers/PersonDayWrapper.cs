...
namespace Daysim.DomainModels.LD.Wrappers {
	...
	public class PersonDayWrapper : Default.Wrappers.PersonDayWrapper, ILDPersonDayWrapper {
		private ILDPersonDay _personDay;

		[UsedImplicitly]
		public PersonDayWrapper(IPersonDay personDay, IPersonWrapper personWrapper, IHouseholdDayWrapper householdDayWrapper) : base(personDay, personWrapper, householdDayWrapper) {
			_personDay = (ILDPersonDay) personDay;
		}
