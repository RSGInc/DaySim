    ...
    public sealed class TDMTripListExporter : IDisposable {
        ...
        public void Export(ITripWrapper trip) {
            ...
            if (Global.Configuration.UseCustomTDMTripListFormat)  {
                ...
                var tsMode = trip.Mode == Global.Settings.Modes.Walk
                                 ? 1
                ...
                var tsPass = trip.Mode == Global.Settings.Modes.Hov2
                                 ? 1
                ...
                var votType = (trip.Mode < Global.Settings.Modes.Sov || trip.Mode > Global.Settings.Modes.Hov3)
                                  ? 0
                                  : ((tripVOT < 30
                                          ? 1 + (int)tripVOT
                                          : tripVOT < 100
