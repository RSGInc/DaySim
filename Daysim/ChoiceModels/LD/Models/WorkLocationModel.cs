...
namespace Daysim.ChoiceModels.LD.Models {
	public class WorkLocationModel : ChoiceModel {
		private const string CHOICE_MODEL_NAME = "LDWorkLocationModel";
...
//				var mixedUse4Index = destinationParcel.MixedUse4Index2();
				...
				// Stefan
				bool isInCopenhagenMunicipality = true; //destinationParcel.Municipality == 101;  Need to change this after Municipality property is added to LD parcel file
				...
				////alternative.AddUtilityTerm(10, (person.Household.ResidenceParcel.Municipality == destination.Municipality).ToFlag());  // Acivate this after Municipality property is added to LD parcel file
