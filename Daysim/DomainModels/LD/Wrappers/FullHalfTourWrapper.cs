...
namespace Daysim.DomainModels.LD.Wrappers {
	...
	public class FullHalfTourWrapper : Default.Wrappers.FullHalfTourWrapper, ILDFullHalfTourWrapper {
		private readonly ILDFullHalfTour _fullHalfTour;
		...
		public FullHalfTourWrapper(IFullHalfTour fullHalfTour, IHouseholdDayWrapper householdDayWrapper) : base(fullHalfTour, householdDayWrapper) {
			_fullHalfTour = (ILDFullHalfTour) fullHalfTour;
		}
	}
}