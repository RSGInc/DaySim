...
namespace Daysim.DomainModels.LD.Wrappers {
	...
	public class HouseholdWrapper : Default.Wrappers.HouseholdWrapper, ILDHouseholdWrapper {
		private readonly ILDHousehold _household;

		[UsedImplicitly]
		public HouseholdWrapper(IHousehold household) : base(household) {
			_household = (ILDHousehold) household;
		}
