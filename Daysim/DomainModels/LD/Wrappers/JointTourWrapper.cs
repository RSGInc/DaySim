...
namespace Daysim.DomainModels.LD.Wrappers {
	...
	public class JointTourWrapper : Default.Wrappers.JointTourWrapper, ILDJointTourWrapper {
		private readonly ILDJointTour _jointTour;

		[UsedImplicitly]
		public JointTourWrapper(IJointTour jointTour, IHouseholdDayWrapper householdDayWrapper) : base(jointTour, householdDayWrapper) {
			_jointTour = (ILDJointTour) jointTour;
		}
	}
}