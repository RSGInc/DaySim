...
namespace Daysim.DomainModels.LD.Wrappers {
	...
	public class ParcelNodeWrapper : Default.Wrappers.ParcelNodeWrapper, ILDParcelNodeWrapper {
		private readonly ILDParcelNode _parcelNode;

		[UsedImplicitly]
		public ParcelNodeWrapper(IParcelNode parcelNode) : base(parcelNode) {
			_parcelNode = (ILDParcelNode) parcelNode;
		}
	}
}